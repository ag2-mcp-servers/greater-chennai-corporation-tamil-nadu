...
class CertificateParameters(BaseModel):
    DATEOFBIRTH: str = Field(..., description='Date of Birth', examples=['15/01/2012'])
    REGNO: str = Field(
        ..., description='Registration Number', examples=['2012/05/049/001034/0']
    )
...
class CertificateParameters1(BaseModel):
    DATEOFDEATH: str = Field(..., description='Date of Death', examples=['20/01/2012'])
    REGNO: str = Field(
        ..., description='Registration Number', examples=['2013/04/045/001204/0']
    )
